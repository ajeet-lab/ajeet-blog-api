...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> findByPostName(@PathVariable String keyword){
    	List<PostDto> postDtos = this.postService.findByPostName(keyword);
    	
    	return new ResponseEntity<List<PostDto>>(postDtos, HttpStatus.OK);
    }
    
    @GetMapping("/posts/search/content/{keyword}")
    public ResponseEntity<List<PostDto>> findByContent(@PathVariable String keyword){
    	List<PostDto> postDtos = this.postService.findByContent(keyword);
